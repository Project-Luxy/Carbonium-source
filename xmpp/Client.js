...
module.exports = class Client extends EventEmitter {
    ...
    handlemessage(message) {
        if (message.root.attributes.type == "chat") {
            ...
            if (msg == "!help" || msg == "!Help")
            {
                var text = '\n' +
                '========================================' + '\n' +
                '!Skin      Cambia la skin al bot' + '\n' +
                '!Emote     Cambia il ballo al bot' + '\n' +
                '!Copy      Ti copia' + '\n' +
                '!Addbot    Aggiunge 1 bot al party' + '\n' +
                '!Add4bot   Aggiunge 4 bot al party' + '\n' +
                '!BackPack  Cambia lo zaino al bot' + '\n' +
                '========================================' + '\n'
    ...
    JoinBot(PartyId) {
        ...
        setTimeout(() => {
                        ...
                        "#text": JSON.stringify(
                            {
                                ...
                                "member_state_updated": {
                                    ...
                                    "Default:AthenaBannerInfo_j": "{\"AthenaBannerInfo\":{\"bannerIconId\":\"BRseason01\",\"bannerColorId\":\"defaultcolor12\",\"seasonLevel\":999}}",
                                    "Default:BattlePassInfo_j": "{\"BattlePassInfo\":{\"bHasPurchasedPass\":false,\"passLevel\":999,\"selfBoostXp\":0,\"friendBoostXp\":0}}",
            ...
            this.setAllBotsSkins(BotConfig.skin || "CID_039_Athena_Commando_F_Disco")
            if (BotConfig.emote) {
                        ...
                        "#text": JSON.stringify(
                            {
                                ...
                                "member_state_updated": {
                                    ...
                                    "Default:AthenaCosmeticLoadoutVariants_j": "{\"AthenaCosmeticLoadoutVariants\":{\"vL\":{\"AthenaPickaxe\":{\"i\":[{\"c\":\"Mesh\",\"v\":\"Stage0\",\"dE\":0}]},\"AthenaCharacter\":{\"i\":[{\"c\":\"Progressive\",\"v\":\"Stage2\",\"dE\":0},{\"c\":\"Material\",\"v\":\"Mat1\",\"dE\":0}]},\"AthenaBackpack\":{\"i\":[{\"c\":\"Material\",\"v\":\"Mat2\",\"dE\":0}]}}}}",
                                    "Default:ArbitraryCustomDataStore_j": "{\"ArbitraryCustomDataStore\":[]}",
                                    "Default:AthenaBannerInfo_j": "{\"AthenaBannerInfo\":{\"bannerIconId\":\"BRseason02\",\"bannerColorId\":\"defaultcolor12\",\"seasonLevel\":999}}",
                                    "Default:BattlePassInfo_j": "{\"BattlePassInfo\":{\"bHasPurchasedPass\":false,\"passLevel\":999,\"selfBoostXp\":0,\"friendBoostXp\":0}}",
                                    "Default:Platform_j": "{\"Platform\":{\"platformDescription\":{\"name\":\"WIN\",\"platformType\":\"DESKTOP\",\"onlineSubsystem\":\"None\",\"sessionType\":\"\",\"externalAccountType\":\"\",\"crossplayPool\":\"DESKTOP\"}}}",
                                    "Default:PlatformUniqueId_s": "INVALID",
                                    "Default:PlatformSessionId_s": "",
